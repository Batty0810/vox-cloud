/* @ds-bundle: {"format":4,"namespace":"NymbisDesignSystem_bca8fb","components":[{"name":"Alert","sourcePath":"components/Alert.jsx"},{"name":"Badge","sourcePath":"components/Badge.jsx"},{"name":"Button","sourcePath":"components/Button.jsx"},{"name":"Card","sourcePath":"components/Card.jsx"},{"name":"Input","sourcePath":"components/Input.jsx"}],"sourceHashes":{"components/Alert.jsx":"a6805b93cd30","components/Badge.jsx":"1ad33e14dc54","components/Button.jsx":"1a773ff39e5f","components/Card.jsx":"f8ce529a456a","components/Input.jsx":"9d9b7d17462a","ui_kits/nymbis-marketing/doc-page.js":"f52ae9c02fca"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.NymbisDesignSystem_bca8fb = window.NymbisDesignSystem_bca8fb || {});
...
const TONES = {
  info: {
    background: 'rgba(144,0,128,0.10)',
    color: '#900080',
    dot: '#900080'
  },
  critical: {
    background: 'rgba(255,26,64,0.10)',
    color: '#FF1A40',
    dot: '#FF1A40'
  },
  healthy: {
    background: 'rgba(66,10,56,0.10)',
    color: '#420A38',
    dot: '#420A38'
  },
  atRisk: {
    background: 'rgba(255,88,60,0.12)',
    color: '#FF583C',
    dot: '#FF583C'
  },
  solid: {
  ...
  outline: {
    ...
    color: '#900080',
    dot: '#900080',
    boxShadow: 'inset 0 0 0 1.5px #900080'
  },
  neutral: {
...
const TONES = {
  primary: {
    background: 'var(--nymbis-plum)',
    color: '#fff',
    border: '1.5px solid transparent',
    boxShadow: 'var(--shadow-glow)'
  },
  secondary: {
    background: 'var(--nymbis-plum-deep)',
    color: '#fff',
    border: '1.5px solid transparent'
  },
  outline: {
    background: '#fff',
    color: 'var(--nymbis-plum)',
    border: '1.5px solid var(--nymbis-plum)'
  },
  ghost: {
...
function Card({
  ...
  const dark = tone === 'plum' || tone === 'deep';
  const bg = tone === 'plum' ? 'var(--nymbis-plum)' : tone === 'deep' ? 'var(--nymbis-plum-deep)' : '#fff';
  return /*#__PURE__*/React.createElement("article", {
    style: {
      background: bg,
      borderRadius: 'var(--radius-lg)',
      padding: 'var(--sp-6)',
      border: dark ? '1px solid transparent' : '1px solid var(--border-1)',
    ...
    style: {
      ...
      fontWeight: 600,
      fontVariationSettings: "'wdth' 112, 'wght' 600",
      color: dark ? 'rgba(255,255,255,0.7)' : 'var(--nymbis-red)'
    }
...
function Input({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      fontFamily: 'var(--font-sans)',
      fontVariationSettings: "'wdth' 112, 'wght' 400",
      fontSize: 15,
      padding: '12px 14px',
      borderRadius: 'var(--radius-sm)',
      border: `1.5px solid ${error ? 'var(--nymbis-red)' : 'var(--border-1)'}`,
      background: '#fff',
      color: 'var(--fg-1)',
      outline: 'none',
    ...
    style: {
      ...
      fontSize: 12,
      marginTop: 6,
      color: error ? 'var(--nymbis-red)' : 'var(--fg-3)'
    }
  }, helper) : null);
}
...
// ui_kits/nymbis-marketing/doc-page.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/nymbis-marketing/doc-page.js", error: String((e && e.message) || e) }); }
